...
class SimpleMonitor13(simple_switch_13.SimpleSwitch13):
    ...
    def _flow_stats_reply_handler(self, ev):
        # self.logger.info("DEBUG: Received FlowStatsReply from %s", ev.msg.datapath.id)
        body = ev.msg.body
        ...
        for stat in body:
            ...
            if stat.instructions and hasattr(stat.instructions[0], 'actions'):
                self.fields['out-port'] = stat.instructions[0].actions[0].port
            else:
                self.fields['out-port'] = 0
